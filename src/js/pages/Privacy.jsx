...
import {HOME_ROUTE, PRIVACY_ROUTE} from '../utils/const';

const Privacy = () => {
  return (
    <section className="privacy__content">
      <span className="privacy__content__title">Политика в отношении обработки персональных данных</span>
      <span className="privacy__content__title-1">1. Общие положение</span>
      <span className="privacy__content__text">Настоящая политика обработки персональных данных
        ...
        безопасности персональных данных, предпринимаемые Pets Friendly (далее –
        Оператор).
        <br/><br/>
        ...
        получить о посетителях веб-сайта <Link to={HOME_ROUTE}>https://pets-friendly.ru</Link>.</span>
      <span className="privacy__content__title-1">2. Основные понятия, используемые в Политике</span>
      <span className="privacy__content__text">2.1. Автоматизированная обработка персональных
        ...
        сетевому адресу <Link to={HOME_ROUTE}>https://pets-friendly.ru</Link>.
        <br/>
        <br/>
        ...
        определенному или определяемому Пользователю веб-сайта  <Link to={HOME_ROUTE}>https://pets-friendly.ru</Link>.
        <br/>
        <br/>
        ...
        <br/>
        <br/>
        2.10. Пользователь – любой посетитель веб-сайта <Link to={HOME_ROUTE}>https://pets-friendly.ru</Link>.
        <br/>
        <br/>
        ...
        размещение в информационно-телекоммуникационных сетях или предоставление доступа
      ...
      <span className="privacy__content__title-1">3. Основные права и обязанности Оператора</span>
      <span className="content_text">3.1. Оператор имеет право: – получать от субъекта
        персональных данных достоверные информацию и/или документы, содержащие
        персональные данные; – в случае отзыва субъектом персональных данных согласия на
        ...
        указанных в Законе о персональных данных; – самостоятельно определять состав и
        перечень мер, необходимых и достаточных для обеспечения выполнения обязанностей,
        предусмотренных Законом о персональных данных и принятыми в соответствии с ним
        нормативными правовыми актами, если иное не предусмотрено Законом о персональных
        ...
        <br/>
        <br/>
        – исполнять иные обязанности, предусмотренные Законом о персональных данных.</span>
      <span className="privacy__content__title-1">4. Основные права и обязанности субъектов персональных данных</span>
      <span className="privacy__content__text">4.1. Субъекты персональных данных имеют право:
        <br/>
        <br/>
        ...
        данных. 4.3. Лица, передавшие Оператору недостоверные сведения о себе, либо
        сведения о другом субъекте персональных данных без согласия последнего, несут
        ответственность в соответствии с законодательством РФ.</span>
      <span className="privacy__content__title-1">5. Оператор может обрабатывать следующие персональные данные Пользователя</span>
      <span className="privacy__content__text">5.1. Фамилия, имя, отчество.
        <br/>
        <br/>
        ...
        <br/>
        <br/>
        5.4. Вышеперечисленные данные далее по тексту Политики объединены общим понятием
        Персональные данные.
        <br/>
        <br/>
        ...
        <br/>
        <br/>
        5.6. Обработка персональных данных, разрешенных для распространения, из числа
        ...
        <br/>
        <br/>
        5.7. Согласие Пользователя на обработку персональных данных, разрешенных для
        ...
        <br/>
        <br/>
        5.7.2 Оператор обязан в срок не позднее трех рабочих дней с момента получения
        ...
        требования, указанного в п. 5.7.3 настоящей Политики в отношении обработки
        персональных данных.</span>
      <span className="privacy__content__title-1">6. Принципы обработки персональных данных</span>
      <span className="privacy__content__text">6.1. Обработка персональных данных осуществляется на
        ...
        не предусмотрено федеральным законом.</span>
      <span className="privacy__content__title-1">7. Цели обработки персональных данных</span>
      <span className="privacy__content__text">7.1. Цель обработки персональных данных Пользователя:
        <br/>
        <br/>
        ...
        Оператору письмо на адрес электронной почты <a href="mailto:info@pets-friendly.ru">info@pets-friendly.ru</a>
        ...
        сайте, улучшения качества сайта и его содержания.</span>
      <span className="privacy__content__title-1">8. Правовые основания обработки персональных данных</span>
      <span className="privacy__content__text">8.1. Правовыми основаниями обработки персональных данных Оператором являются:
        <br/>
        <br/>
        ...
        расположенные на сайте <Link to={HOME_ROUTE}>https://pets-friendly.ru</Link>
        ...
        предоставлении его персональных данных и дает согласие свободно, своей волей и в
        своем интересе.</span>
      <span className="privacy__content__title-1">9. Условия обработки персональных данных</span>
      <span className="privacy__content__text">9.1. Обработка персональных данных осуществляется с
        ...
        обязательному раскрытию в соответствии с федеральным законом.</span>
      <span className="privacy__content__title-1">10. Порядок сбора, хранения, передачи и других
        видов обработки персональных данных</span>
      <span className="privacy__content__text">Безопасность персональных данных, которые
        ...
        адрес электронной почты Оператора <a href="mailto:info@pets-friendly.ru">info@pets-friendly.ru</a>
        ...
        почты на электронный адрес Оператора <a href="mailto:info@pets-friendly.ru">info@pets-friendly.ru</a>
      ...
      <span className="privacy__content__title-1">11. Перечень действий, производимых Оператором с
        полученными персональными данными</span>
      <span className="privacy__content__text">11.1. Оператор осуществляет сбор, запись,
        систематизацию, накопление, хранение, уточнение (обновление, изменение),
        извлечение, использование, передачу (распространение, предоставление, доступ),
        ...
        информационно-телекоммуникационным сетям или без таковой.</span>
      <span className="privacy__content__title-1">12. Трансграничная передача персональных данных</span>
      <span className="privacy__content__text">12.1. Оператор до начала осуществления
        ...
        стороной которого является субъект персональных данных.</span>
      <span className="privacy__content__title-1">13. Конфиденциальность персональных данных</span>
      <span className="privacy__content__text">Оператор и иные лица, получившие доступ к
      ...
      <span className="privacy__content__title-1">14. Заключительные положения</span>
      <span className="privacy__content__text">14.1. Пользователь может получить любые разъяснения
        по интересующим вопросам, касающимся обработки его персональных данных,
        обратившись к Оператору с помощью электронной почты <a href="mailto:info@pets-friendly.ru">info@pets-friendly.ru</a>.
        <br/><br/>
        ...
        по адресу <Link to={PRIVACY_ROUTE}>https://pets-friendly.ru/privacy/</Link>
      </span>
    </section>
  )
}
